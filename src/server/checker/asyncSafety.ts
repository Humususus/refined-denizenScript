 ...
 */
export const ASYNC_SAFE_COMMANDS: ReadonlySet<string> = new Set([
 ...
 */
export const ASYNC_DEFERRABLE_COMMANDS: ReadonlySet<string> = new Set([
...
export const ASYNC_SAFE_EVERYTHING_TYPES: ReadonlySet<string> = new Set([
 ...
 */
export const ASYNC_SAFE_TYPE_TAGS: ReadonlyMap<string, ReadonlySet<string>> = new Map([
 ...
 */
export const ASYNC_MAIN_THREAD_ONLY_BASES: ReadonlySet<string> = new Set([
 ...
 */
export const ASYNC_BARE_SAFE_BASES: ReadonlySet<string> = new Set(['player', 'npc']);
 ...
 */
export function asyncBlockCommandName(blockLineText: string): string | null {
 ...
 */
export function isAsyncSafeCommand(commandName: string): boolean {
    return ASYNC_SAFE_COMMANDS.has(commandName) || ASYNC_DEFERRABLE_COMMANDS.has(commandName);
}
 ...
 */
export function isAsyncSafeTypeTag(typeName: string, subTag: string): boolean {
    const type = typeName.toLowerCase();
    if (ASYNC_SAFE_EVERYTHING_TYPES.has(type)) {
        return true;
    }
    const safe = ASYNC_SAFE_TYPE_TAGS.get(type);
    if (safe === undefined) {
        return true;
    }
