...
export class MixedKnowledgeSet {
     ...
     */
    mergeIn(set: MixedKnowledgeSet): void {
     ...
     */
    getAllMatchesIn(options: Iterable<string>): string[] {
        const result: string[] = [];
