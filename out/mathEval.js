...
exports.looksArithmetic = exports.evaluateMathTag = exports.formatNumber = exports.SUPPORTED_OPERATIONS = void 0;
const tagHelper_1 = require("./server/providers/tagHelper");
...
exports.SUPPORTED_OPERATIONS = new Set([...Object.keys(BINARY), ...Object.keys(UNARY)]);
/**
 ...
 */
function operand(text, supplied, inputs) {
    const trimmed = text.trim();
 ...
 */
function evaluateParsed(tagText, supplied, inputs) {
    const parsed = (0, tagHelper_1.parseTag)(tagText, () => { });
    ...
    const opIndex = parsed.parts.findIndex(p => exports.SUPPORTED_OPERATIONS.has(p.text));
...
function named(name, supplied, inputs) {
...
function applyChain(start, parts, supplied, inputs) {
    let current = start;
 ...
 */
function evaluateMathTag(tagText, supplied = new Map()) {
    var _a;
    const inner = (_a = unwrapTag(tagText)) !== null && _a !== void 0 ? _a : tagText.trim();
    if (inner.length === 0) {
...
exports.evaluateMathTag = evaluateMathTag;
/**
 ...
 */
function looksArithmetic(tagText) {
    var _a;
    const inner = (_a = unwrapTag(tagText)) !== null && _a !== void 0 ? _a : tagText.trim();
    const parsed = (0, tagHelper_1.parseTag)(inner, () => { });
    return parsed.parts.some(p => exports.SUPPORTED_OPERATIONS.has(p.text));
}
exports.looksArithmetic = looksArithmetic;
//# sourceMappingURL=mathEval.js.map