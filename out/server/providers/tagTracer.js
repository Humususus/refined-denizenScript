...
class TagTracer {
    ...
    trace() {
        ...
        let superComplexBaseTag;
        let veryComplexBaseTag;
        let complexBaseTag;
        let realBaseTag;
        let documentedObjectBase;
        // TagTracer.cs:44-47.
        ...
        const rootReturnTypes = new Set();
        for (const rootTag of (_a = this.possibleTags.get(0)) !== null && _a !== void 0 ? _a : []) {
     ...
     */
    parsePossibleTypes(returnType, known) {
        var _a;
        ...
        if (known === null || known === undefined) {
            known = (_a = this.docs.objectTypes.get(returnType)) !== null && _a !== void 0 ? _a : null;
        }
    ...
    traceTagParts(possibleRoots, index) {
        var _a, _b;
        const parts = this.tag.parts;
        ...
        while (index < parts.length) {
            ...
            for (const p of result) {
                ...
                if (p[0].baseType === this.docs.objectTagType && p[0].afterDotCleaned === 'as') {
                    ...
                    let castType = ((_a = parts[index].parameter) !== null && _a !== void 0 ? _a : '').toLowerCase();
    ...
    getFullComplexSetFrom(original) {
        // TagTracer.cs:222.
    ...
    traceTagPartSingle(possibleRoots, index) {
        ...
        if (possibleRoots === null || possibleRoots.has(null)) {
            return null;
        }
        const parts = this.tag.parts;
...
function traceTag(docs, tag, callbacks) {
    ...
    return {
        possibleSubTypes: (_a = tracer.possibleSubTypes.get(tag.parts.length - 1)) !== null && _a !== void 0 ? _a : new Set(),
        possibleTags: tracer.possibleTags
    };
}
exports.traceTag = traceTag;
//# sourceMappingURL=tagTracer.js.map