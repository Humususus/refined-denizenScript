...
exports.provideSignatureHelp = exports.tokenizeSyntax = void 0;
...
exports.tokenizeSyntax = tokenizeSyntax;
...
function provideSignatureHelp(docs, text, offset) {
    ...
    const parameters = tokens.map(token => ({
        label: [token.start, token.end]
    }));
    const signature = {
        label: command.syntax,
        documentation: { kind: vscode_languageserver_1.MarkupKind.Markdown, value: (0, describe_1.descriptionClean)(command.short) },
        parameters
    };
    return {
