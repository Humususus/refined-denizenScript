...
function checkSingleTag(checker, line, startChar, tag, context) {
    ...
    const trace = (0, tagTracer_1.traceTag)(meta, parsed, {
        error: (s) => {
        ...
        for (let i = 0; i < parsed.parts.length; i++) {
            ...
            if (format !== null && format.parts.length <= 2 && part.parameter !== null && part.parameter.length > 0) {
                ...
                if (metaPart.parameter !== null && metaPart.parameter.startsWith('<')) {
                    ...
                    const input = (0, frenetic_1.toLowerFast)((0, frenetic_1.before)(part.parameter, '['));
...
function isOnlySimpleNoteName(text) {
 ...
 */
function checkTagParam(checker, part, metaPart, input, warnPart) {
    var _a;
    ...
    const safeParam = ((_a = part.parameter) !== null && _a !== void 0 ? _a : '').replaceAll('`', "'");
    switch (metaPart.parameter) {
        ...
        case '<material>':
            if (!data.items.has(input) && !data.blocks.has(input)
                && (0, containerConvert_1.contextValidatedGetScriptFor)(checker, input, 'item') === null
                && (0, containerConvert_1.contextValidatedGetScriptFor)(checker, input, 'book') === null) {
        ...
        case '<entity>':
            if (!data.entities.has(input) && (0, containerConvert_1.contextValidatedGetScriptFor)(checker, input, 'entity') === null) {
        ...
        // make it live again.
        case '<inventory>':
            if (!eventValidators_1.INVENTORY_MATCHERS.has(input)
                && (0, containerConvert_1.contextValidatedGetScriptFor)(checker, input, 'inventory') === null
        ...
        case '<procedure_script_name>':
            if ((0, containerConvert_1.contextValidatedGetScriptFor)(checker, input, 'procedure') === null) {
