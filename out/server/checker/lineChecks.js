...
exports.checkForOldDefs = exports.checkForBraces = exports.checkForTabs = exports.checkForColorCodes = exports.basicLineFormatCheck = exports.firstNonWhitespaceIndex = exports.countPreSpaces = void 0;
...
function basicLineFormatCheck(checker) {
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        if (line.endsWith(' ')) {
            ...
            checker.warn(checker.warnings, i, 'useless_invalid_line', 'Useless/invalid line (possibly missing a `-` or a `:`, or just accidentally hit enter or paste).', firstNonWhitespaceIndex(lines[i]), lines[i].length);
        }
